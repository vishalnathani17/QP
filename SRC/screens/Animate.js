...
var images = [
  { id: 1, src: require('../image/krutika.jpg') },
  { id: 2, src: require('../image/krutika.jpg') },
  { id: 3, src: require('../image/krutika.jpg') },
  { id: 4, src: require('../image/krutika.jpg') },
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={StyleSheet.absoluteFill}
          ...
          <Animated.View style={[{ flex: 1, zIndex: 1000, backgroundColor: 'white', padding: 20, paddingTop: 50 }, animatedContentStyle]}>
            <Text style={{ fontSize: 24, paddingBottom: 10 }}>Krutika Aditya</Text>
            <Text>Over 6 years experience working as a senior tutor for a renowned professional qualifications tuition provider.</Text>
          </Animated.View>
        </View>
      </SafeAreaView>
    );
